...
int do_config(void)
{
	...
	cfg.session_storagetype = setup_config_box(ctrlbox, FALSE, 0, 0, 0); // HACK: PuttyTray / PuTTY File, Added 0 for 'int session_storagetype'
...
int do_reconfig(HWND hwnd, int protcfginfo)
{
    ...
    ctrlbox = ctrl_new_box();
    cfg.session_storagetype = setup_config_box(ctrlbox, TRUE, cfg.protocol, protcfginfo, cfg.session_storagetype); // HACK: PuttyTray / PuTTY File, Added 'session_storagetype'
